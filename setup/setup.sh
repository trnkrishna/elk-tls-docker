...
apt update && apt install unzip openssl -y
...
create_certificates()
{
    ...
    sed "s/MAIN_IP1/${MAIN_IP1}/g" $CONFIG_DIR/instances-template.yml > $CONFIG_DIR/instances.yml
    sed -i "s/MAIN_IP2/${MAIN_IP2}/g" $CONFIG_DIR/instances.yml
